    ...
    >
      ...
      <Portal>
        ...
        >
          ...
          <Button
            mode={selectedFilter === "titleAsc" ? "contained" : "outlined"}
            onPress={() => handleFilter("titleAsc")}
            style={styles.filterButton}
            theme={theme}
          >
            Title (A to Z)
          ...
          <Button
            mode={selectedFilter === "titleDesc" ? "contained" : "outlined"}
            onPress={() => handleFilter("titleDesc")}
            style={styles.filterButton}
            theme={theme}
          >
            Title (Z to A)
          ...
          <Button
            mode={selectedFilter === "dateAsc" ? "contained" : "outlined"}
            onPress={() => handleFilter("dateAsc")}
            style={styles.filterButton}
            theme={theme}
          >
            Date (Oldest First)
          ...
          <Button
            mode={selectedFilter === "dateDesc" ? "contained" : "outlined"}
            onPress={() => handleFilter("dateDesc")}
            style={styles.filterButton}
            theme={theme}
          >
            Date (Newest First)
